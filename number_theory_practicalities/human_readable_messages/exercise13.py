...
""""
 --------------------------------------------------------------------------------------
    ...
    EXERCISE 13:Send Simmons a human-readable message that you have encoded using UTF-8 
    and encrypted using padding. Simmons' RSA public key is (n, e) where
...
n= int('',base=16)
e=65537
message_marina= ' Zero, esse nada que é tudo. (Laisant)'.encode('utf8')
message_laura= ' La matemática es llave y puerta de la ciencia. Roger Bacon'.encode('utf8')



print("Marina's encrypted message",RSAencrypt(n, e, message_marina))

print("Lauras's encrypted message",RSAencrypt(n, e, message_laura))
