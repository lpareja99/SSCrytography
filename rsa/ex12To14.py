...
def decipherToNum_3(e,n,num):
    ...
    p = order[0]
    q= order[1]
    # test if the fermat factoring is correct
    if (p*q==n):
        print("true")
    ...
    d = inverse
    solution=pow(num,d,n)
    print("Solution for challenge 4 is:",solution)
...
# Exercise 4: Robertson uses 512-bit primes to generate his RSA public-key. For his encryption key $\{n, e\}$, he uses $e =$ 65537 and $n$ equal to (in hex):
